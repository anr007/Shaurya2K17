...
public class MatchRecyclerViewOnClickListener implements RecyclerView.OnItemTouchListener{
    ...
    public MatchRecyclerViewOnClickListener(Context ctx, final RecyclerView rv,
