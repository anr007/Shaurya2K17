...
public class AboutShauryaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_about_shaurya);
        ...
        textSurface=(TextSurface)findViewById(R.id.about_text_surface);
    ...
    public static void play(TextSurface textSurface) {
        ...
        Text textB = TextBuilder.create("All the Departments of NIT Mizoram Participate In this Event")
                ...
                .setColor(android.R.color.black)
                .build();
        Text textC = TextBuilder.create("Many games have been conducted in this event over the past 7 years.")
